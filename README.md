...
Есть готовый [навык для AI-ассистентов](docs/AI-INTEGRATION.md) (Claude Code, Roo Code, Kilo-Code).
...
- 🤖 **[Интеграция с AI-ассистентами (AI-INTEGRATION.md)](docs/AI-INTEGRATION.md)** — установка навыка для Claude Code, Roo Code, Kilo-Code.
